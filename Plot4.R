...
plot(datetime,plot.data$Global_active_power,ylab='Global Active Power',main='',type='l',xlab='')

plot(datetime,plot.data$Voltage,main='',xlab='datetime',ylab='Voltage',type='l')
...
plot(datetime,plot.data$Global_reactive_power,main='',xlab='datetime',ylab='Global Reactivate Power',type='l')
